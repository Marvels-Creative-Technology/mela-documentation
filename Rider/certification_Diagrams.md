# Mela for Mekedonia — INSA Audit Diagrams (Mermaid)

> All diagrams below use [Mermaid](https://mermaid.js.org/) syntax and can be rendered in any Mermaid-compatible viewer (GitHub, VS Code Mermaid Preview, Mermaid Live Editor, etc.)
...
*Generated for Marvels Creative Technology — INSA Cybersecurity Audit Submission, February 2025*
